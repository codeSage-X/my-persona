(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/node_modules_@firebase_firestore_dist_lite_index_browser_esm2017_a899bf10.js", {
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ const A = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$logger$2f$dist$2f$esm$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Logger"]("@firebase/firestore");
/**
...
function __PRIVATE_logDebug(t, ...e) {
    if (A.logLevel <= __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$logger$2f$dist$2f$esm$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LogLevel"].DEBUG) {
        const r = e.map(__PRIVATE_argToString);
        A.debug(`Firestore (${m}): ${t}`, ...r);
    }
}
function __PRIVATE_logError(t, ...e) {
    if (A.logLevel <= __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$logger$2f$dist$2f$esm$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LogLevel"].ERROR) {
        const r = e.map(__PRIVATE_argToString);
 ...
 */ function __PRIVATE_logWarn(t, ...e) {
    if (A.logLevel <= __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$logger$2f$dist$2f$esm$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LogLevel"].WARN) {
        const r = e.map(__PRIVATE_argToString);
...
/** AppCheck token provider for the Lite SDK. */ class __PRIVATE_LiteAppCheckTokenProvider {
    constructor(e, r){
        this.h = r, this.appCheck = null, this.m = null, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$esm$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["_isFirebaseServerApp"])(e) && e.settings.appCheckToken && (this.m = e.settings.appCheckToken), r.onInit((t)=>{
            this.appCheck = t;
        });
    }
    getToken() {
...
/** Compare strings in UTF-8 encoded byte order */ function __PRIVATE_compareUtf8Strings(t, e) {
    ...
    for(; r < t.length && r < e.length;){
        ...
        if (n !== i) {
            if (n < 128 && i < 128) // ASCII comparison
 ...
 */ class BasePath {
    ...
    static extractNumericId(t) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$webchannel$2d$wrapper$2f$dist$2f$bloom$2d$blob$2f$esm$2f$bloom_blob_es2018$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Integer"].fromString(t.substring(4, t.length - 2));
    }
}
/**
 ...
 */ class __PRIVATE_RestConnection {
    ...
    I(t, e, r, n, i) {
        ...
        return this.p(a, n, i), this.F(t, o, a, r).then((e)=>(__PRIVATE_logDebug(L, `Received RPC '${t}' ${s}: `, e), e), (e)=>{
            throw __PRIVATE_logWarn(L, `RPC '${t}' ${s} failed with error: `, e, "url: ", o, "request:", r), e;
        });
    }
    v(t, e, r, n, i, s) {
 ...
 */ class __PRIVATE_ExponentialBackoff {
     ...
     */ r = 1e3, n = 1.5, i = 6e4){
        this.L = t, this.timerId = e, this.M = r, this.U = n, this.k = i, this.j = 0, this.W = null, /** The last backoff attempt, as epoch milliseconds. */ this.K = Date.now(), this.reset();
    }
    /**
 ...
 */ class __PRIVATE_DatastoreImpl extends Datastore {
    constructor(t, e, r, n){
        super(), this.authCredentials = t, this.appCheckCredentials = e, this.connection = r, this.serializer = n, this.Z = !1;
    }
    X() {
    ...
    /** Invokes the provided RPC with auth and AppCheck tokens. */ I(t, e, r, n) {
        ...
        ]).then(([i, s])=>this.connection.I(t, __PRIVATE_toResourcePath(e, r), n, i, s)).catch((t)=>{
            throw "FirebaseError" === t.name ? (t.code === g && (this.authCredentials.invalidateToken(), this.appCheckCredentials.invalidateToken()), t) : new FirestoreError(R, t.toString());
        });
    }
    /** Invokes the provided RPC with streamed results with auth and AppCheck tokens. */ v(t, e, r, n, i) {
        return this.X(), Promise.all([
            this.authCredentials.getToken(),
            this.appCheckCredentials.getToken()
        ]).then(([s, o])=>this.connection.v(t, __PRIVATE_toResourcePath(e, r), n, s, o, i)).catch((t)=>{
            throw "FirebaseError" === t.name ? (t.code === g && (this.authCredentials.invalidateToken(), this.appCheckCredentials.invalidateToken()), t) : new FirestoreError(R, t.toString());
        });
    }
    terminate() {
...
async function __PRIVATE_invokeRunAggregationQueryRpc(t, e, r) {
    ...
    const i = __PRIVATE_debugCast(t), { request: s, tt: o, parent: a } = function __PRIVATE_toRunAggregationQueryRequest(t, e, r, n) {
        ...
        const e = __PRIVATE_debugCast(t);
        return e.q || (// Do not include implicit order-bys for aggregate queries.
        e.q = __PRIVATE__queryToTarget(e, t.explicitOrderBy)), e.q;
    }(e), r);
    i.connection.A || delete s.parent;
    const u = (await i.v("RunAggregationQuery", i.serializer.databaseId, a, s, /*expectedResponseCount=*/ 1)).filter((t)=>!!t.result);
...
function getFirestore(t, r) {
    const n = "object" == typeof t ? t : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$esm$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getApp"])(), i = "string" == typeof t ? t : r || "(default)", s = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$esm$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["_getProvider"])(n, "firestore/lite").getImmediate({
        identifier: i
    });
    if (!s._initialized) {
 ...
 */ function connectFirestoreEmulator(t, e, r, n = {}) {
    ...
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$util$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deepEqual"])(u, o) && (t._setSettings(u), n.mockUserToken)) {
        let e, r;
...
class __PRIVATE_ArrayUnionFieldValueImpl extends FieldValue {
    ...
    _toFieldTransform(t) {
        const e = __PRIVATE_createSentinelChildContext(this, t, /*array=*/ !0), r = this.ft.map((t)=>__PRIVATE_parseData(t, e)), n = new __PRIVATE_ArrayUnionTransformOperation(r);
        return new FieldTransform(t.path, n);
    }
    isEqual(t) {
        return t instanceof __PRIVATE_ArrayUnionFieldValueImpl && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$util$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deepEqual"])(this.ft, t.ft);
    }
}
class __PRIVATE_ArrayRemoveFieldValueImpl extends FieldValue {
    ...
    _toFieldTransform(t) {
        const e = __PRIVATE_createSentinelChildContext(this, t, /*array=*/ !0), r = this.ft.map((t)=>__PRIVATE_parseData(t, e)), n = new __PRIVATE_ArrayRemoveTransformOperation(r);
        return new FieldTransform(t.path, n);
    }
    isEqual(t) {
        return t instanceof __PRIVATE_ArrayRemoveFieldValueImpl && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$util$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deepEqual"])(this.ft, t.ft);
    }
}
...
/** Parse update data from a list of field/value arguments. */ function __PRIVATE_parseUpdateVarargs(t, e, r, n, i, s) {
    const o = t.dt(1 /* UserDataSource.Update */ , e, r), a = [
 ...
 */ function __PRIVATE_fieldPathFromDotSeparatedString(t, e, r) {
    if (e.search(ot) >= 0) throw __PRIVATE_createError(`Invalid field path (${e}). Paths must not contain '~', '*', '/', '[', or ']'`, t, /* hasConverter= */ !1, /* path= */ void 0, r);
    try {
...
function __PRIVATE_validateReference(t, e) {
    if ((t = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$util$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getModularInstance"])(t)).firestore !== e) throw new FirestoreError(I, "Provided document reference is from a different Firestore instance.");
    return t;
}
/**
 ...
 */ class __PRIVATE_TransactionRunner {
    constructor(t, e, r, n, i){
        this.asyncQueue = t, this.datastore = e, this.options = r, this.updateFunction = n, this.deferred = i, this.At = r.maxAttempts, this.Tt = new __PRIVATE_ExponentialBackoff(this.asyncQueue, "transaction_retry" /* TimerId.TransactionRetry */ );
    }
...
class __PRIVATE_AsyncQueueImpl {
    constructor(t = Promise.resolve()){
        ...
        // be changed again.
        this.gt = !1, // Operations scheduled to be queued in the future. Operations are
        ...
        this.bt = !1, // List of TimerIds to fast-forward delays for.
        this.Ct = [], // Backoff timer used to schedule retries for retryable operations
        this.Tt = new __PRIVATE_ExponentialBackoff(this, "async_queue_retry" /* TimerId.AsyncQueueRetry */ ), // Visibility handler that triggers an immediate retry of all retryable
        // operations. Meant to speed up recovery when we regain file system access
        // after page comes into foreground.
        this.St = ()=>{
            const t = getDocument();
            t && __PRIVATE_logDebug(ut, "Visibility state changed to " + t.visibilityState), this.Tt.Y();
        }, this.Nt = t;
        const e = getDocument();
    ...
    enqueue(t) {
        if (this.Ot(), this.gt) // Return a Promise which never resolves.
        return new Promise(()=>{});
 ...
 */ function __PRIVATE_getMessageOrStack(t) {
     ...
     */ Mt(t) {
        ...
        return this.Qt().then(()=>{
            ...
            /* eslint-disable-next-line @typescript-eslint/no-floating-promises */ this.Ft.sort((t, e)=>t.targetTimeMs - e.targetTimeMs);
    ...
    !function __PRIVATE_setSDKVersion(t) {
        ...
        const n = t.getProvider("app").getImmediate(), i = new Firestore(new __PRIVATE_LiteAuthCredentialsProvider(t.getProvider("auth-internal")), new __PRIVATE_LiteAppCheckTokenProvider(n, t.getProvider("app-check-internal")), function __PRIVATE_databaseIdFromApp(t, e) {
            if (!Object.prototype.hasOwnProperty.apply(t.options, [
                "projectId"
            ])) throw new FirestoreError(I, '"projectId" not provided in firebase.initializeApp.');
...
//# sourceMappingURL=node_modules_%40firebase_firestore_dist_lite_index_browser_esm2017_a899bf10.js.map