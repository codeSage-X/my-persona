...
export function ReviewForm({ open, onOpenChange, onSubmit }: ReviewFormProps) {
  ...
  />
  <p className="text-xs text-muted-foreground">Upload a profile image. Will not be saved permanently.</p>

  {photoUrl && (
    // eslint-disable-next-line @next/next/no-img-element
    <img
      src="https://res.cloudinary.com/xenxei46/image/upload/v1745451231/avatar-1577909_1280_q2lzbc.webp"
      alt="Preview"
